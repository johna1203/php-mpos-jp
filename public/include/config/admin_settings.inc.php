...
$aSettings['website'][] = array(
    'display' => 'メンテナンスモード', 'type' => 'select',
    'options' => array(0 => 'はい', 1 => 'いいえ'),
    'default' => 0,
    'name'    => 'maintenance', 'value' => $setting->getValue('maintenance'),
    'tooltip' => 'メンテナンスを有効か無効かを選択して下さい. 管理者ユーザーだけがログインできます。'
);
$aSettings['website'][] = array(
    'display' => '本日のメッセージ', 'type' => 'text',
    'size'    => 25,
    'default' => '',
    'name'    => 'system_motd', 'value' => $setting->getValue('system_motd'),
    'tooltip' => 'メッセージを設定した場合、訪問ユーザーにメッセージが表示されます。'
);
$aSettings['website'][] = array(
    'display' => 'サイト名', 'type' => 'text',
    'size'    => 25,
    'default' => 'The Pool',
    'name'    => 'website_name', 'value' => $setting->getValue('website_name'),
    'tooltip' => 'プールサイトの名前を入力して下さい、 ページのヘッダー部分に表示されます。'
);
$aSettings['website'][] = array(
