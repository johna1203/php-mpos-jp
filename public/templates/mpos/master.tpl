...
<head>
    ...
    <!--[if IE]>
    <script type="text/javascript" src="{$PATH}/js/excanvas.js"></script><![endif]-->
    ...
    <style type="text/css">
        ...
        .box {
            min-height: 180px;
            background: url("{$PATH}/images/moe/fukidashi/rika.png") no-repeat left center;
            position: relative;
        }
        ...
        .box .hukidasi:before {
            ...
            border-right: 12px solid #B5E5EF;
        }
    </style>
...
<section id="main" class="column">
    {if is_array($smarty.session.POPUP|default)}
        {section popup $smarty.session.POPUP}
            <div class="box">
                <h4 class="{$smarty.session.POPUP[popup].TYPE|default:"info"} hukidasi">{$smarty.session.POPUP[popup].CONTENT}</h4>
            </div>
        {/section}
    {/if}
